...
//
// Rotation pattern (10 regular : 2 affiliate, repeating forever):
//   position = ((counter - 1) % 12) + 1
//   position 1-10 -> regular checkout link
//   position 11-12 -> affiliate checkout link
//
...
async function handleCheckoutGet(request, env) {
  ...
  const position = ((counter - 1) % 12) + 1;
  const destination = position <= 10 ? regularUrl : affiliateUrl;
